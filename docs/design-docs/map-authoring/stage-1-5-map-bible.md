...
| Stage | 상태 | 핵심 목표 |
| --- | --- | --- |
| Stage 1 | 기준 확정 | 사방 압박 입문, 장애물 우회 이해 |
| Stage 2 | 다음 작업 | 방향별 압박 강약 차이 학습 |
| Stage 3 | 초안 전 | 첫 중장 체크 |
| Stage 4 | 초안 전 | 성 근처 최종 방어 압박 |
| Stage 5 | 초안 전 | 초반 규칙 종합 시험 |

## 초반 5개 Stage 공통 방향

- 성 위치는 우선 `중앙 또는 거의 중앙`을 기준으로 쓴다
- 초반에는 장애물 수를 충분히 둬서 적이 돌아오게 만든다
- 플레이어가 킬존을 만들 시간을 확보한다
...
1. Stage 2 작업 카드 작성
2. Stage 2 좌표와 ASCII 초안 작성
3. Stage 2 구현 후 플레이 검증
4. 같은 방식으로 Stage 3~5 확장
