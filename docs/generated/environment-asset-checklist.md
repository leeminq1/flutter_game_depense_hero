# Environment Asset Checklist

## Purpose

Reserve the first environment production batch against the new stage art bible.

References:

- `docs/design-docs/stage-art-bible.md`
- `docs/design-docs/environment-asset-matrix.md`
- `docs/design-docs/size-and-silhouette-rules.md`
- `assets/sprites/manifest/environment_visual_slots.json`

## Generated Shared Reusable Props
...
- `assets/sprites/environment/props/ritual_altar.png`
...
- Towers should read larger than enemies.
- Props should usually read below towers in visual dominance.
- Landmarks can be larger than towers, but should not look buildable.
